...
from app_blog.form import UserRegisterForm, PostForm, RankingForm, CommentForm, AvatarForm, UserEditForm, MessageForm
...
def profile(request):
    ...
    return render(
        request=request,
        context=context_dict,
        template_name="app_blog/profile_form.html",
    )
